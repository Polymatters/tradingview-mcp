...
export function registerChartTools(server) {
  // L2 PRAGMATIC TEST MODE: all chart tools enabled (read + navigation).
  // Mutating chart navigation is enabled — Claude can change symbol/timeframe/etc. on user request.
